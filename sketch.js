...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if((keyDown("space") || touches.lenght>0 )&& trex.y >= width-350)  {
      trex.velocityY = -10;
      touches=[];
    }
...
function spawnClouds() {
  ...
  if (frameCount % 80 === 0) {
    var cloud = createSprite(700,120,40,height-80);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(invisibleGround.x+500,invisibleGround.y-30,10,40);
    //obstacle.debug = true;
